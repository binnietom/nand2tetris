...
If you find a security vulnerability in nand2tetris, please report it through [GitHub's private vulnerability reporting](https://github.com/Tom Binnie/nand2tetris/security/advisories/new). This keeps the details private while we work on a fix.
